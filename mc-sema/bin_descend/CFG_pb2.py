...
_GLOBALVAR = _descriptor.Descriptor(
  name='GlobalVar',
  full_name='GlobalVar',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='var', full_name='GlobalVar.var', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='address', full_name='GlobalVar.address', index=1,
      number=2, type=3, cpp_type=2, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MODULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='global_vars', full_name='Module.global_vars', index=7,
...
_GLOBALVAR.fields_by_name['var'].message_type = _VARIABLE
...
_MODULE.fields_by_name['global_vars'].message_type = _GLOBALVAR
...
DESCRIPTOR.message_types_by_name['GlobalVar'] = _GLOBALVAR
...
class GlobalVar(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _GLOBALVAR

  # @@protoc_insertion_point(class_scope:GlobalVar)
